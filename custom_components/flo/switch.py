...
# Sleep mode options (in minutes)
SLEEP_MINUTE_OPTIONS = [60, 120, 180, 240, 300, 360, 420, 480, 540, 600, 660, 720]
# System mode constants
SYSTEM_MODE_HOME = FLO_HOME
SYSTEM_REVERT_MODES = [FLO_HOME, FLO_AWAY]
