...
async def validate_input(hass: HomeAssistant, data):
    ...
    try:
        await async_get_api(hass, data[CONF_USERNAME], data[CONF_PASSWORD])
    except (FloAuthError, FloRequestError) as error:
        LOGGER.error("Error connecting to the Flo API: %s", error)
